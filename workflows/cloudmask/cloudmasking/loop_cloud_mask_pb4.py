...
inDir = "/home/ubuntu/cloud_masking/s2cloudless/outputs/Post-250122"
...
for file in os.listdir(directory):
    ...
    if filename.endswith(".tif"):
        ...
        # cloud detector requires units as REFLECTANCE. Convert DN to Reflectance as 'Refl = DN / 1000' applying band offsets
        # as needed since upgrade to PB 4.00 (only for files > PB 4.00 from 25/01/22). These are detailed in Product XML file and involve subtracting 1000 from each band
        refl_reshaped_bands = (ten_bands - 1000) / 10000
